...
knn_5_predictions = knn_5.fit(____, ____).predict(____)
knn_10_predictions = knn_10.fit(____, ____).predict(____)
knn_20_predictions = knn_20.fit(____, ____).predict(____)

# Get an accuracy score for each of the models
knn_5_accuracy = accuracy_score(y_test, ____)
knn_10_accuracy = accuracy_score(y_test, ____)
knn_20_accuracy = accuracy_score(y_test, ____)
print("The accuracy of 5, 10, 20 neighbours was {}, {}, {}".format(____))
```
