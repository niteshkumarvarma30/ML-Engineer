...
*(When you run this code, you will notice that K-Means struggles to perfectly segment the giant head from the two small ears, proving its bias towards making all clusters equal in physical size!)*
