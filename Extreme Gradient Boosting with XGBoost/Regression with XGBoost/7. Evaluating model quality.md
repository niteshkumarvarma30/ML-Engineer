...
### Concept: RMSE and MAE in Cross-Validation
...
3. Now, adapt your code to compute the `"mae"` instead of the `"rmse"`. *(We provide both parts in the solution below!)*
