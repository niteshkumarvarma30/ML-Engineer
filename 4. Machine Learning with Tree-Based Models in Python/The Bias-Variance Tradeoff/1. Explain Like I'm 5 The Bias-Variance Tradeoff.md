...
> [!NOTE]
> **TL;DR Summary:**
> * **Bias is Underfitting:** The model is too simple or stubborn and completely misses the real pattern (consistently guessing wrong).
> * **Variance is Overfitting:** The model is too sensitive and memorizes the practice data perfectly, but fails when it sees new data (wildly inconsistent).
...
![Bias-Variance Dartboards](bias_variance_dartboards.svg)
