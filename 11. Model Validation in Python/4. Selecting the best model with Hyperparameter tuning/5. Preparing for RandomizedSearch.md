...
After learning about `RandomizedSearchCV()`, you're revisiting your professor's challenge to build the best model. In this exercise, you will prepare the three necessary inputs for completing a random search.
